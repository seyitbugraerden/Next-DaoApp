    ...
    <div className="bg-mainColor">
        <div className="flex flex-col xl:flex-row justify-start items-center gap-10 max-w-[80%] mx-auto pb-5">
          <Image
            ...
            height="2232"
            alt="abstract image"
            className="rounded-xl  xl:max-w-[35vw] h-[70vh] object-cover"
          />
          <Image
            src={img2}
            width="1116"
            height="1578"
            alt="abstract image"
            className="rounded-xl xl:max-w-[25vw] h-[50vh] object-cover"
          />
          <Image
            src={img3}
            width="1116"
            height="848"
            alt="abstract image"
            className="rounded-xl xl:max-w-[20vw] object-cover"
          />
        </div>
    </div>
  );
