        ...
        <div className="row d-flex gx-5 align-items-center">
          ...
          >
            <div className="flex flex-col gap-10">
              <div className="bg-bgColor flex flex-col p-8 rounded-[36px]">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div
                className="flex flex-col p-8 rounded-[36px]"
                style={{
                  backgroundImage:
                    "linear-gradient(to right top, #140e12, #281827, #382340, #432f5e, #51448b, #5e4897, #6c4ca2, #894292, #9c3a7f, #a9356b, #ae3756, #ae3756)",
                }}
              >
                <div className="flex flex-row gap-1 items-center">
                  <svg
