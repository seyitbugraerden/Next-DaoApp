...
async function page() {
  ...
  const career = userId
    ? await pb
        .collection("users")
        .getOne(userId, { expand: "relField1,relField2.subRelField" })
        .then((record) => ({
